...
// Request Access Info Page
Route::get('/request-access', function () {
    return Inertia::render('request-access');
})->name('request-access');
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('billing')->name('billing.')->middleware('role:billing')->group(function () {
    ...
    Route::prefix('admitting')->name('admitting.')->middleware('role:admitting')->group(function () {
